...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Redes 95 — Escritorio" },
      { property: "og:description", content: "Escritorio Windows 95 para aprender redes, HTTP, HTML, lógica y terminal. Con XP, monedas y medallas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Redes 95 — Escritorio" },
      { name: "twitter:description", content: "Escritorio Windows 95 para aprender redes, HTTP, HTML, lógica y terminal. Con XP, monedas y medallas." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9536560a-2454-49c2-a596-778aecdb3385/id-preview-6b43149a--d0821d87-61a1-48b5-bb6c-3b704f612f02.lovable.app-1784518453467.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9536560a-2454-49c2-a596-778aecdb3385/id-preview-6b43149a--d0821d87-61a1-48b5-bb6c-3b704f612f02.lovable.app-1784518453467.png" },
    ],
    links: [
